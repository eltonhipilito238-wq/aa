...
local BACKGROUND_IMAGE_ID = "rbxassetid://YOUR_IMAGE_ID"
...
Main.Name = "Main"
Main.Size = UDim2.fromOffset(900, 590)
...
Sidebar.Size = UDim2.new(0, 175, 1, -84)
...
Status.Position = UDim2.new(0, 9, 1, -75)
...
Content.Size = UDim2.new(1, -197, 1, -84)
Content.Position = UDim2.fromOffset(187, 74)
...
RunService.RenderStepped:Connect(function()
    ...
    -- Music
    Music.Volume =
        math.clamp(Settings.MusicVolume / 100,0,5)
